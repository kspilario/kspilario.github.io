...
Our laboratory specializes in *computational research* in engineering, with a particular focus on developing algorithms for the *design and modelling, optimization, control, and monitoring* (see upper left, lower left, upper right, lower right quadrants of our logo, respectively) of systems at various scales in the process industries, energy, water, and environment. Through our inter-disciplinary research, we aim to develop innovative solutions that cut across various applications, while contributing to the achievement of the U.N. Sustainable Development Goals.
